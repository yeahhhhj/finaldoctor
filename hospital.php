  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <h1 class="mb-2 bread">병원</h1>
        <p class="breadcrumbs"><span class="mr-2"><a href="index.php">홈 <i class="ion-ios-arrow-forward"></i></a></span> <span>병원<i class="ion-ios-arrow-forward"></i></span></p>
      </div>
    </div>
  </div>
</section>
...
<script>
  ...
  function searchPlaces(locPosition) {
      ...
      ps.keywordSearch(  '서울시 병원', placesSearchCB);
      ps.keywordSearch(  '경기도 병원', placesSearchCB);
      ps.keywordSearch(  '인천시 병원', placesSearchCB);
      ps.keywordSearch(  '강원도 병원', placesSearchCB);
      //ps.keywordSearch(  '충청도 병원', placesSearchCB);
      ps.keywordSearch(  '충청북도 병원', placesSearchCB);
      ps.keywordSearch(  '충청남도 병원', placesSearchCB);
      ps.keywordSearch(  '경상북도 병원', placesSearchCB);
      ps.keywordSearch(  '경상남도 병원', placesSearchCB);
      ps.keywordSearch(  '전라북도 병원', placesSearchCB);
      ps.keywordSearch(  '전라남도 병원', placesSearchCB);
      ps.keywordSearch(  '대전시 병원', placesSearchCB);
      ps.keywordSearch(  '광주시 병원', placesSearchCB);
      ps.keywordSearch(  '대구시 병원', placesSearchCB);
      ps.keywordSearch(  '울산시 병원', placesSearchCB);
      ps.keywordSearch(  '부산시 병원', placesSearchCB);
      ps.keywordSearch(  '세종시 병원', placesSearchCB);
      ps.keywordSearch(  '제주시 병원', placesSearchCB);
